          ...
          {isLoading ? (
            <div className="grid gap-8 pt-6 md:grid-cols-2 xl:grid-cols-3">
              {Array.from({ length: 6 }).map((_, index) => (
                <div
                  key={index}
                  className="animate-pulse space-y-4 rounded-3xl border border-neutral-200/80 bg-white p-6 shadow-subtle/40"
                >
                  <div className="h-48 rounded-2xl bg-neutral-200/80" />
                  <div className="h-4 w-2/3 rounded-full bg-neutral-200" />
                  <div className="h-4 w-full rounded-full bg-neutral-200/80" />
                  <div className="h-4 w-3/5 rounded-full bg-neutral-200/70" />
                </div>
              ))}
            </div>
          ) : isError ? (
            <div className="col-span-full mt-6 rounded-3xl border border-dashed border-neutral-300 bg-white/80 p-10 text-center text-neutral-500">
                    ...
                    <button
                      ...
                      className={
                        isActive
                          ...
                          : 'rounded-full px-3 py-1 text-xs font-medium text-neutral-600 hover:bg-neutral-100'
                      }
                    >
                      {pageNumber}
                    </button>
